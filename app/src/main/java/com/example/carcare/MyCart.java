...
public class MyCart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tm = (TextView) findViewById(R.id.Appointmnet_time);
        ...
        float totalAmount = 0;
        ArrayList dbData = db.getCartData(username,"carcheckup");
        ...
        back_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MyCart.this, CarCheckup.class));
                finish();
            }
        });
        ...
        btncheckout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(MyCart.this, CheckOut.class);
                it.putExtra("price",pi);
                it.putExtra("date",dt.getText().toString());
                it.putExtra("time",tm.getText().toString());
                startActivity(it);
                finish();
            }
        });
