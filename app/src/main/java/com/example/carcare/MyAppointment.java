...
public class MyAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList dbData = db.getOrderData(username,"appointment","carcheckup");
        ...
        for(int i=0;i<order_details.length;i++){
            ...
            if(strData[7].compareTo("Accessories")==0){
        ...
        back_a.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name != null && name.equals("user")) {
                    startActivity(new Intent(MyAppointment.this, UserProfile.class));
                    finish();
                } else {
                    startActivity(new Intent(MyAppointment.this, HomeActivity.class));
                    finish();
                }
